...
function Login() {
    ...
    const handleLogin = async (e) => {
        ...
        setLoading(true);
        try {
            const response = await axios.post('https://namami-infotech.com/PushpRatan/src/auth/login.php', {
                EmpId: empId,
                password: password,
            });
    ...
    const handleForgotPasswordSubmit = async () => {
        try {
            setLoading(true);
            const response = await axios.post('https://namami-infotech.com/PushpRatan/src/auth/forget_password.php', {
                email: forgotEmail,
            });
