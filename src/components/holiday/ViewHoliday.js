...
function ViewHoliday() {
    ...
    const fetchHolidays = async () => {
        try {
            const response = await axios.get('https://namami-infotech.com/PushpRatan/src/holiday/view_holiday.php');
    ...
    return (
        <div className="calendar-container">
            ...
            <EditHoliday open={editDialogOpen} onClose={() => setEditDialogOpen(false)} holiday={selectedHoliday} onHolidayUpdated={fetchHolidays} />
