...
const EmployeeData = ({ EmpId }) => {
    ...
    useEffect(() => {
        const fetchEmployeeData = async () => {
            try {
                const response = await axios.get(`https://namami-infotech.com/PushpRatan/src/employee/view_employee.php?EmpId=${EmpId}`);
                const leaveResponse = await axios.get(`https://namami-infotech.com/PushpRatan/src/leave/balance_leave.php?empid=${EmpId}`);
                const expenseResponse = await axios.get(`https://namami-infotech.com/PushpRatan/src/expense/get_expense.php?EmpId=${EmpId}`);
                const attendanceResponse = await axios.get(`https://namami-infotech.com/PushpRatan/src/attendance/view_attendance.php?EmpId=${EmpId}`);
                const assetResponse = await axios.get(`https://namami-infotech.com/PushpRatan/src/assets/get_issue_asset.php?EmpId=${EmpId}`);
