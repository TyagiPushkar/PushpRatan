...
function ViewExpense() {
    ...
    useEffect(() => {
        const fetchExpenses = async () => {
            try {
                ...
                const response = await axios.get('https://namami-infotech.com/PushpRatan/src/expense/get_expense.php', {
    ...
    const handleStatusChange = async (detailId, status) => {
        try {
            const response = await axios.post('https://namami-infotech.com/PushpRatan/src/expense/update_expense.php', {
                detailId,
                status,
                role: user.role
            });
